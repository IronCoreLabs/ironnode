...
- Added user operation `disableSelf` to deactivate the calling user.
- Added user operation `updateUserStatus` to enable or disable a user administratively via a JWT generated from the IronCore Config and Identity Assertion Key.
- Dependency updates.
