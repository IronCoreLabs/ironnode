...
import {PublicKey, RecryptEncryptedMessage, TransformedEncryptedMessage} from "../commonTypes";

export const testAccountID = "10";
export const testSegmentID = 30;
export const testCurrentKeyId = 53;
...
export const accountEncryptedPrivateKeyBytes = Buffer.from("OSfTv0+o+Rb5OAd8vX9cR/V/h0xZJHA6WSZ+Jrl77iY=", "base64");
...
export const getTestApiState = (): [string, number, PublicKey<Buffer>, Buffer, Buffer, Buffer, number] => [
    testAccountID,
    testSegmentID,
    accountPublicBytes,
    accountEncryptedPrivateKeyBytes,
    devicePrivateBytes,
    signingPrivateBytes,
    testCurrentKeyId,
];

export const getEncryptedSymmetricKey = (): RecryptEncryptedMessage => ({
    encryptedMessage:
...
export const getTransformedSymmetricKey = (): TransformedEncryptedMessage => ({
...
export const getEncryptedDocumentMetaResponse = (): DocumentMetaGetResponseType => ({
...
export const getEmptyPublicKey = (): PublicKey<Buffer> => ({
    x: Buffer.from([]),
    y: Buffer.from([]),
});

export const getEmptyPublicKeyString = (): PublicKey<string> => ({
